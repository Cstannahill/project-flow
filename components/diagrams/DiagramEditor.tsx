...
import { diagramTypes } from "@/lib/mermaidPresets"; // Adjust the import path as needed
...
type Props = {
  ...
  initialType?: string;
  onSaveAction: (data: { content: string; type: string }) => void;
};
  ...
  return (
    <div className="border rounded-lg p-4 space-y-4 bg-white dark:bg-neutral-900">
      ...
      <div className="flex justify-end">
        <button
          onClick={() => onSaveAction({ content, type })}
